...
Personal skills in `~/.agents/skills/` are **general**. They must not name a specific repository, product, organisation, or UI language. Repo-specific vocabulary lives in that repo (`docs/terminology.md`, `AGENTS.md`, project rules).
...
2. **Target location**: Should this be a personal skill (`~/.agents/skills/`) or project skill (`.cursor/skills/`)?
...
- "Where should this skill be stored?" with options like ["Personal (~/.agents/skills/)", "Project (.cursor/skills/)"]
...
### 6. Repo- or product-specific content in a personal skill
- ✅ Good: "Follow the target repository’s `AGENTS.md` and `docs/terminology.md`"
- ❌ Avoid: naming one organisation, product, or UI language in `~/.agents/skills/`
...
6. If personal: confirm it names no specific repo, product, or organisation
...
- [ ] Personal skills stay general (no specific repo or product)
